  ...
  return (
    <div className="min-h-screen bg-[#E8F4FC]">
      ...
      <header className="px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 bg-[#5B8DEF] rounded-full flex items-center justify-center">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="text-white">
                <circle cx="12" cy="8" r="4" stroke="currentColor" strokeWidth="2.5" fill="none"/>
                <path d="M4 20C4 16 7.5 13 12 13C16.5 13 20 16 20 20" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" fill="none"/>
              </svg>
            </div>
            <div>
      ...
      <main className="px-6 py-4 space-y-6">
        ...
        {/* Weekly Progress */}
        <div className="bg-[#268DF4] rounded-2xl p-5 text-white">
