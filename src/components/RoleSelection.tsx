        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            <div className="text-center">
              ...
              <p className="text-muted-foreground mb-4">
                Создам аккаунт и буду следить за прогрессом ребёнка
              </p>
              <ul className="text-sm text-left space-y-2 text-muted-foreground">
                <li>✓ Полная аналитика прогресса</li>
                <li>✓ Настройка функционала</li>
                <li>✓ Родительский контроль</li>
                <li>✓ Создание кодов для ребёнка</li>
              </ul>
            </div>
          </Card>
          ...
          >
            <div className="text-center">
              ...
              <ul className="text-sm text-left space-y-2 text-muted-foreground">
                <li>✓ Рисование и творчество</li>
                <li>✓ Интересные задания</li>
                <li>✓ Игры с друзьями</li>
