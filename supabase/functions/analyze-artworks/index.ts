...
ФОРМАТ JSON ОТВЕТА:
{
  ...
  "ceolina_feedback": "позитивное сообщение для ребенка от персонажа Ceolina",
...
6. Создай вдохновляющее сообщение от Ceolina для ребенка
...
ВАЖНО: Используй детально-ориентированный, терапевтически-осознанный язык. Избегай негативных диагностических формулировок.`;
    ...
    try {
      ...
      analysis = {
        ...
        ceolina_feedback: "Ты замечательно выражаешь свои эмоции через рисунки! Продолжай творить! ✨",
